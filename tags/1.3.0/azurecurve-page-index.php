...
function azc_display_page_index($atts, $content = null) {
	...
	foreach ($myrows as $myrow){
		...
		$output .= "<a href='".$page_url."/".$myrow->post_name."/' class='azc_pi' style='$color $background $width $height $lineheight $margin $textalign $padding $fontweight'>".$myrow->post_title."</a>";
	}
